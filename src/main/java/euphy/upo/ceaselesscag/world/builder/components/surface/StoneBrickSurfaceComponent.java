 ...
 * 石砖路面组件
 */
public class StoneBrickSurfaceComponent implements IBuilderComponent {

    private static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(CeaselessCaG.MODID, "stone_brick_surface_3w");
    private static final int WIDTH = 3;

    private static final BlockState CENTER_BLOCK = Blocks.STONE_BRICKS.defaultBlockState();
